...
PARSER.add('--dream_env', required=True, type=int, help='0 to train controller in real env 1 to train controller in '
                                                        'dream')
...
PARSER.add('--rnn_min_learning_rate', required=True, type=float, help='prevent decaying rnn learning rate paste this '
                                                                      'threshold')
...
PARSER.add('--controller_retrain', type=int, default=0, help='set to 0 to disable retraining every eval_steps if '
