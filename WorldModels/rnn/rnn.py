...
class MDNRNN(tf.keras.Model):
    def __init__(self, args):
        ...
        self.args = args
        self.optimizer = tf.keras.optimizers.Adam(learning_rate=self.args.rnn_learning_rate,
                                                  clipvalue=self.args.rnn_grad_clip)

        self.loss_fn = self.get_loss()
        self.inference_base = tf.keras.layers.LSTM(units=args.rnn_size, return_sequences=True, return_state=True,
                                                   time_major=False)
